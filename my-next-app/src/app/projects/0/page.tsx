      ...
      <div>
        ...
        <Section>
          ...
          <div className="multi-column-text">
            ...
            <p>
              ...
              great—especially the audio, which is sometimes hard to understand.
        ...
        <Section>
          ...
          <div className="multi-column-text">
            ...
            <p>
              <strong>Repositories</strong> – As much as possible, I leveraged
              the capabilities of SQL and PostgreSQL. It&#39;s surprising how
              complex behavior is possible with just pure SQL.
            </p>
          </div>
          <Image
        ...
        <Section>
          ...
          <div className="multi-column-text mb-big">
            ...
            <p>
              ...
              app. Fast-flowing flashcards. Fetches practice items in small
              chunks of 10. After finishing a chunk, it posts progress to the
              backend and fetches a new chunk.
            </p>
          </div>
